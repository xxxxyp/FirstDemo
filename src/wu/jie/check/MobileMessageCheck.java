...
import wu.jie.send.CheckSumBuilder;
...
public class MobileMessageCheck {
    ...
    private static final String APP_KEY="b78ecd0f2a43b8e7f711c52ffbd8aeac";//账号
    private static final String APP_SECRET="29b6cce311b1";//密钥
